          ...
          >
            ...
            {[
              ...
              >
                ...
                <div>
                  <div style={{ fontSize: '0.75rem', color: '#9ca3af', fontFamily: 'var(--font-sans)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>{label}</div>
                  <div style={{ fontSize: '0.92rem', color: 'var(--color-coffee)', fontWeight: 500 }}>{value}</div>
                </div>
              </motion.a>
            ))}

            {/* Hours */}
            <div style={{ marginTop: '1.5rem', padding: '1.5rem', borderRadius: '1rem', background: 'rgba(212,163,115,0.08)', border: '1px solid rgba(212,163,115,0.15)' }}>
              <h4 style={{ fontFamily: 'var(--font-serif)', fontSize: '1rem', color: 'var(--color-coffee)', marginBottom: '0.75rem' }}>Opening Hours</h4>
              {[
                ...
                <div key={day} style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.4rem' }}>
                  <span style={{ fontSize: '0.85rem', color: '#6b7280' }}>{day}</span>
                  <span style={{ fontSize: '0.85rem', color: 'var(--color-coffee)', fontWeight: 500 }}>{time}</span>
                </div>
              ))}
            </div>
          </motion.div>
            ...
            <AnimatePresence mode="wait">
              {submitted ? (
                ...
                >
                  ...
                  <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: '1.5rem', color: 'var(--color-coffee)', marginBottom: '0.5rem' }}>
                    Message Sent!
                  </h3>
                ...
                >
                  <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: '1.4rem', color: 'var(--color-coffee)', marginBottom: '0.5rem' }}>
                    Send Us a Message
                  </h3>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                    <div>
                      <input
                        ...
                        style={{ color: 'var(--color-coffee)', background: '#f9fafb' }}
                      />
                    </div>
                    <div>
                      <input
                  ...
                  <textarea
                    ...
                    style={{ resize: 'vertical', color: 'var(--color-coffee)', background: '#f9fafb' }}
                  />

                  {/* Newsletter */}
                  <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer' }}>
                    <input type="checkbox" {...register('newsletter')} style={{ accentColor: '#D4A373', width: 16, height: 16 }} />
                    <span style={{ fontSize: '0.82rem', color: '#6b7280' }}>Subscribe to our newsletter for offers & events</span>
                  </label>
